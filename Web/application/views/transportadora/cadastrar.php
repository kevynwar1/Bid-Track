...
<div class="content">
	<div class="container-fluid">
		<div class="row">
			<div id="row-transportadora" class="col-md-12" style="transition: 0.5s;">
				<div class="card">
					<div class="card-header" data-background-color="blue-left">
						<h4 class="title">Transportadora</h4>
						<p class="category">Cadastre a <span id="empresa-title">Transportadora</span></p>
					</div>
			...
			<div id="row-transportadora-info" class="col-md-4" style="display: none;">
				<div class="card">
					<div class="card-header" data-background-color="blue-center">
						<h4 class="title">Informações</h4>
						<p class="category">Detalhamento da Transportadora</p>
					</div>
					<div class="card-content">
