...
<script type="text/javascript">
	function exclusao(codigo) {
		...
		$('.btn-confirm-yes').on('click', function(event){
			...
			window.location.replace("<?= base_url() ?>tipoocorrencia/excluir/"+codigo);
			return true;
		});
...
<div class="cd-popup" role="alert">
	<div class="cd-popup-container">
		<p><?= $this->session->userdata('nome') ?>, tem certeza que quer<br> excluir este Tipo de Ocorrência ?</p>
		<ul class="cd-buttons">
		...
		<div class="row">
									...
									<tr>
										...
										<td>
											<?php if($this->session->userdata('perfil') == 'A'): ?>
												<a href="<?= base_url().'tipoocorrencia/editar/'.$row->codigo; ?>">
													<button type="button" rel="tooltip" data-placement="left" title="Editar" class="btn-pattern">
														<i class="fa fa-edit"></i>
													</button>
												</a>
												<a href="<?= base_url().'tipoocorrencia/excluir/'.$row->codigo; ?>" onclick="return exclusao('<?= $row->codigo ?>')" rel="tooltip" data-placement="left" title="Excluir" class="btn-pattern">
			...
			<div class="col-md-6">
				<div class="card">
					<div class="card-header" data-background-color="blue-center">
						<h4 class="title">Tipo de Ocorrência</h4>
						<p class="category">Editar um Tipo de Ocorrência</p>
					</div>
					<div class="card-content">
						<form action="<?= base_url().'tipoocorrencia/editar' ?>" method="post" autocomplete="off">
						<div class="row">
							<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6">
								<a href="<?= base_url(); ?>tipoocorrencia" class="btn btn-danger btn-simple">Voltar</a>
							</div>
							<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="card">
					<div class="card-header" data-background-color="blue-center">
						<h4 class="title">Tipo de Ocorrência</h4>
						<p class="category">Cadastre um Tipo de Ocorrência</p>
					</div>
					<div class="card-content">
						<form action="<?= base_url().'tipoocorrencia/cadastrar' ?>" method="post" autocomplete="off">
						<div class="row">
							<div class="col-md-12">
								<div class="form-group label-floating">
									<label class="control-label">Descrição</label>
						...
						<div class="row">
							<div class="col-md-12">
								<button type="submit" class="btn btn-danger btn-fill pull-right f12 upper" ng-disabled="!descricao">
									Cadastrar
								</button>
							</div>
						</div>
